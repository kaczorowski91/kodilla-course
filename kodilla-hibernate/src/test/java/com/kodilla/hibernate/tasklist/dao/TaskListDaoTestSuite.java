...
public class TaskListDaoTestSuite {
    ...
    public void testTaskListDaoSaveWithTasks() {
        ...
        String taskListName = taskList.getTasks().get(0).getDescription();
        String taskListName2 = taskList.getTasks().get(1).getDescription();

        //Then
        Assert.assertNotEquals(0, id);
        Assert.assertEquals("Test: Learn Hibernate",taskListName);
        Assert.assertEquals("Test: Write some entities",taskListName2);
