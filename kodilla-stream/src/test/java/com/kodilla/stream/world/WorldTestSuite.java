...
public class WorldTestSuite {
    ...
    public void testGetPeopleQuantity() {
        ...
        Continent europe = new Continent(Arrays.asList(poland, russia, france));
        Continent america = new Continent(Arrays.asList(usa));
        World world = new World(Arrays.asList(europe, america));
        //When
